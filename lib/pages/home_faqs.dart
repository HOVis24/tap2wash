...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const homeFaqs(title: 'Tap2Wash'),
    );
  }
}

class homeFaqs extends StatefulWidget {
  const homeFaqs({super.key, required this.title});

  final String title;

  @override
  State<homeFaqs> createState() => _homeFaqsState();
}

class _homeFaqsState extends State<homeFaqs> {
